...
export type Verification=Pick<ApprovedDocument,'reference'|'course'|'issued'>&{status:'Confirmada'|'Concluído'|'Registado'|'Estornado';kind?:'Inscrição'|'Certificado'|'Pagamento';period?:string;hours?:string};
